...
int WHITE_THRESH = 254, RED_RATIO = 3, motorSpeed = 40, maxLines = 10, safety = 68, defaultLeft = 12, redMode = 0;
...
int main() {
    ...
    //vector to store the distToFrontValues so that we can check if it's decreasing or not
